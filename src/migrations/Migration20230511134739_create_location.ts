...
export class Migration20230511134739_create_location extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "locations" ("id" varchar(255) not null default gen_random_uuid(), "created_at" timestamptz(0) not null default current_timestamp, "updated_at" timestamptz(0) null, "title" varchar(255) not null, "color" varchar(255) null, "show_complete_month" boolean not null default false, "icon" varchar(255) null, "user_id" varchar(255) not null, constraint "locations_pkey" primary key ("id"));');
