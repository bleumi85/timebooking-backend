...
export class Migration20230512055721_create_task extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "tasks" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(0) not null default current_timestamp, "updated_at" timestamptz(0) null, "title" varchar(255) not null, "color" varchar(255) null, "icon" varchar(255) null, "user_id" uuid not null, constraint "tasks_pkey" primary key ("id"));');
